            ...
            <div className="space-y-6" data-aos="fade-right">
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <div className="space-y-5">
                  {[
                    { icon: HiOutlineLocationMarker, label: 'Address', value: 'Sri Kurmanandha Rice & General Stores,near srikakulam old bus stand,Srikakulam dist, Andhra Pradesh, 532401' },
